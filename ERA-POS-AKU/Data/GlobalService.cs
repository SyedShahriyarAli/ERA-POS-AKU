...
public class GlobalService
{
    public Task<List<Product>> GetProducts()
    {
        ...
        {
            new Product { Barcode = "P01", Name = "Banana", Description = "Fresh and ripe banana", Price = 55.0, Tax = 13, Stock = 100, Subsidized = false, SubsidizedPrice = 0 },
            ...
            new Product { Barcode = "P03", Name = "Chicken Wings", Description = "Lean and protein-rich", Price = 200.0, Tax = 13, Stock = 100, Subsidized = false, SubsidizedPrice = 0 },
            new Product { Barcode = "P04", Name = "Salmon Fillet", Description = "Premium quality salmon", Price = 300.0, Tax = 13, Stock = 100, Subsidized = true, SubsidizedPrice = 250 },
            ...
            new Product { Barcode = "P15", Name = "Ice Cream", Description = "Creamy vanilla ice cream", Price = 60.0, Tax = 13, Stock = 100, Subsidized = true, SubsidizedPrice = 30 }
        };
